...
---
### [addNeighbors](https://github.com/iotaledger/iri/blob/dev/src/main/java/com/iota/iri/service/API.java#L1150)
...
command = {"command": "addNeighbors", "uris": "uris": "udp://8.8.8.8:14265"}
...
{"duration": "558", "addedNeighbors": "689"}
</Section>
...
var command = {"command": "addNeighbors", "uris": "uris": "udp://8.8.8.8:14265"}
...
<Section type="response">
{"duration": "840", "addedNeighbors": "821"}
</Section>
...
-d '{"command": "addNeighbors", "uris": "uris": "udp://8.8.8.8:14265"}'
</Section>

<Section type="response">
{"duration": "997", "addedNeighbors": "986"}
</Section>
