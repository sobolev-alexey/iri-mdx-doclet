...
---
### [removeNeighbors](https://github.com/iotaledger/iri/blob/dev/src/main/java/com/iota/iri/service/API.java#L575)
...
command = {"command": "removeNeighbors", "uris": "uris": "udp://8.8.8.8:14265"}
...
{"duration": "24", "removedNeighbors": "508"}
</Section>
...
var command = {"command": "removeNeighbors", "uris": "uris": "udp://8.8.8.8:14265"}
...
<Section type="response">
{"duration": "238", "removedNeighbors": "517"}
</Section>
...
-d '{"command": "removeNeighbors", "uris": "uris": "udp://8.8.8.8:14265"}'
</Section>

<Section type="response">
{"duration": "44", "removedNeighbors": "203"}
</Section>
