...
---
### [removeNeighbors](https://github.com/iotaledger/iri/blob/dev/src/main/java/com/iota/iri/service/API.java#L574)
...
{"duration": "751", "removedNeighbors": "38"}
</Section>
...
<Section type="response">
{"duration": "48", "removedNeighbors": "937"}
</Section>
...
<Section type="response">
{"duration": "573", "removedNeighbors": "13"}
</Section>
