...
---
### [addNeighbors](https://github.com/iotaledger/iri/blob/dev/src/main/java/com/iota/iri/service/API.java#L1148)
...
<Section type="response">
{"duration": "322", "addedNeighbors": "139"}
</Section>
